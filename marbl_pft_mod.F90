module marbl_pft_mod
  ...
  type, public :: autotroph_settings_type
    ...
    real(r8)                :: f_poly                             ! fraction to dissolved polysaccharide pool
    real(r8)                :: f_lipid                            ! fraction to dissolved lipid pool
    real(r8)                :: f_amino_poly                       ! fraction to dissolved amino polysaccharide pool
    real(r8)                :: f_protein                          ! fraction to dissolved protein pool
  contains
  ...
  subroutine autotroph_set_to_default(self, autotroph_id, marbl_status_log)
    ...
    select case (autotroph_id)
      case ('sp')
        ...
        self%f_poly          = 0.2_r8
        self%f_lipid         = 0.15_r8
        self%f_amino_poly    = 0.1_r8
        self%f_protein       = 0.3_r8
      case ('diat')
        ...
        self%f_poly          = 0.1_r8
        self%f_lipid         = 0.2_r8
        self%f_amino_poly    = 0.05_r8
        self%f_protein       = 0.25_r8
      case ('diaz')
        ...
        self%f_poly          = 0.25_r8
        self%f_lipid         = 0.1_r8
        self%f_amino_poly    = 0.15_r8
        self%f_protein       = 0.35_r8
      case ('unset')
        self%sname = 'unknown'
        self%lname = 'unknown'
        self%Nfixer        = .false.
        ...
        self%f_poly          = UnsetValue
        self%f_lipid         = UnsetValue
        self%f_amino_poly    = UnsetValue
        self%f_protein       = UnsetValue
      case DEFAULT
