module marbl_interface_private_types
  ...
  type, public :: autotroph_derived_terms_type
    ...
    real(r8), allocatable :: auto_loss_poly(:,:)  ! auto_loss routed to poly (mmol C/m^3/sec)
    real(r8), allocatable :: auto_loss_lipid(:,:) ! auto_loss routed to lipid (mmol C/m^3/sec)
    real(r8), allocatable :: auto_loss_amino_poly(:,:)   ! auto_loss routed to amino_poly (mmol C/m^3/sec)
    real(r8), allocatable :: auto_loss_protein(:,:) ! auto_loss routed to protein (mmol C/m^3/sec)
    ...
    real(r8), allocatable :: auto_graze_poly(:,:) ! auto_graze routed to poly (mmol C/m^3/sec)
    real(r8), allocatable :: auto_graze_lipid(:,:) ! auto_graze routed to lipid (mmol C/m^3/sec)
    real(r8), allocatable :: auto_graze_amino_poly(:,:)  ! auto_graze routed to amino_poly (mmol C/m^3/sec)
    real(r8), allocatable :: auto_graze_protein(:,:)  ! auto_graze routed to protein (mmol C/m^3/sec)
  ...
  type, public :: zooplankton_derived_terms_type
    ...
    real(r8), allocatable :: zoo_graze_poly(:,:)   ! grazing of zooplankton routed to poly (mmol C/m^3/sec)
    real(r8), allocatable :: zoo_graze_lipid(:,:)  ! grazing of zooplankton routed to lipid (mmol C/m^3/sec)
    real(r8), allocatable :: zoo_graze_amino_poly(:,:) ! grazing of zooplankton routed to amino_poly (mmol C/m^3/sec)
    real(r8), allocatable :: zoo_graze_protein(:,:) ! grazing of zooplankton routed to protein (mmol C/m^3/sec)
    ...
    real(r8), allocatable :: zoo_loss_poly(:,:)    ! zoo_loss routed to poly (mmol C/m^3/sec)
    real(r8), allocatable :: zoo_loss_lipid(:,:)   ! zoo_loss routed to lipid (mmol C/m^3/sec)
    real(r8), allocatable :: zoo_loss_amino_poly(:,:) ! zoo_loss routed to amino_poly (mmol C/m^3/sec)
    real(r8), allocatable :: zoo_loss_protein(:,:) ! zoo_loss routed to protein (mmol C/m^3/sec)
  ...
  type, public :: dissolved_organic_matter_type
     ...
     real(r8), allocatable :: poly_prod(:)        ! production of poly
     real(r8), allocatable :: lipid_prod(:)       ! production of lipid
     real(r8), allocatable :: poly_remin(:)       ! remineralization of poly
     real(r8), allocatable :: lipid_remin(:)      ! remineralization of lipid
     real(r8), allocatable :: DOCr_remin(:)       ! remineralization of DOCr
     real(r8), allocatable :: amino_poly_prod(:)  ! production of amino_poly
     real(r8), allocatable :: protein_prod(:)     ! production of protein
     real(r8), allocatable :: amino_poly_remin(:) ! remineralization of amino_poly
     real(r8), allocatable :: protein_remin(:)    ! remineralization of protein
  ...
  type, public :: marbl_tracer_index_type
    ...
    integer (int_kind) :: poly_ind        = 0 ! dissolved polysaccharides
    integer (int_kind) :: lipid_ind       = 0 ! dissolved lipids
    integer (int_kind) :: amino_poly_ind  = 0 ! dissolved amino polysaccharides
    integer (int_kind) :: protein_ind     = 0 ! dissolved proteins
  ...
  type, public :: marbl_interior_tendency_diagnostics_indexing_type
    ...
    integer(int_kind) :: poly_prod_zint
    integer(int_kind) :: poly_prod_zint_100m
    integer(int_kind) :: poly_remin_zint
    integer(int_kind) :: poly_remin_zint_100m
    integer(int_kind) :: lipid_remin_zint
    integer(int_kind) :: lipid_remin_zint_100m
    ...
    integer(int_kind), allocatable :: auto_graze_poly_zint(:)
    integer(int_kind), allocatable :: auto_graze_poly_zint_100m(:)
    integer(int_kind), allocatable :: auto_graze_lipid_zint(:)
    integer(int_kind), allocatable :: auto_graze_lipid_zint_100m(:)
    integer(int_kind), allocatable :: auto_graze_amino_poly_zint(:)
    integer(int_kind), allocatable :: auto_graze_amino_poly_zint_100m(:)
    integer(int_kind), allocatable :: auto_graze_protein_zint(:)
    integer(int_kind), allocatable :: auto_graze_protein_zint_100m(:)
    ...
    integer(int_kind), allocatable :: auto_loss_poly_zint(:)
    integer(int_kind), allocatable :: auto_loss_poly_zint_100m(:)
    integer(int_kind), allocatable :: auto_loss_lipid_zint(:)
    integer(int_kind), allocatable :: auto_loss_lipid_zint_100m(:)
    integer(int_kind), allocatable :: auto_loss_amino_poly_zint(:)
    integer(int_kind), allocatable :: auto_loss_amino_poly_zint_100m(:)
    integer(int_kind), allocatable :: auto_loss_protein_zint(:)
    integer(int_kind), allocatable :: auto_loss_protein_zint_100m(:)
    ...
    integer(int_kind), allocatable :: zoo_loss_poly_zint(:)
    integer(int_kind), allocatable :: zoo_loss_poly_zint_100m(:)
    integer(int_kind), allocatable :: zoo_loss_lipid_zint(:)
    integer(int_kind), allocatable :: zoo_loss_lipid_zint_100m(:)
    integer(int_kind), allocatable :: zoo_loss_amino_poly_zint(:)
    integer(int_kind), allocatable :: zoo_loss_amino_poly_zint_100m(:)
    integer(int_kind), allocatable :: zoo_loss_protein_zint(:)
    integer(int_kind), allocatable :: zoo_loss_protein_zint_100m(:)
    ...
    integer(int_kind), allocatable :: zoo_graze_poly_zint(:)
    integer(int_kind), allocatable :: zoo_graze_poly_zint_100m(:)
    integer(int_kind), allocatable :: zoo_graze_lipid_zint(:)
    integer(int_kind), allocatable :: zoo_graze_lipid_zint_100m(:)
    integer(int_kind), allocatable :: zoo_graze_amino_poly_zint(:)
    integer(int_kind), allocatable :: zoo_graze_amino_poly_zint_100m(:)
    integer(int_kind), allocatable :: zoo_graze_protein_zint(:)
    integer(int_kind), allocatable :: zoo_graze_protein_zint_100m(:)
    ...
    integer(int_kind) :: poly_prod
    integer(int_kind) :: lipid_prod
    integer(int_kind) :: poly_remin
    integer(int_kind) :: lipid_remin
    integer(int_kind) :: DOCr_remin
    integer(int_kind) :: amino_poly_prod
    integer(int_kind) :: protein_prod
    integer(int_kind) :: amino_poly_remin
    integer(int_kind) :: protein_remin
    ...
    integer(int_kind), allocatable :: auto_graze_poly(:)
    integer(int_kind), allocatable :: auto_graze_lipid(:)
    integer(int_kind), allocatable :: auto_graze_amino_poly(:)
    integer(int_kind), allocatable :: auto_graze_protein(:)
    ...
    integer(int_kind), allocatable :: auto_loss_poly(:)
    integer(int_kind), allocatable :: auto_loss_lipid(:)
    integer(int_kind), allocatable :: auto_loss_amino_poly(:)
    integer(int_kind), allocatable :: auto_loss_protein(:)
    ...
    integer(int_kind), allocatable :: zoo_loss_poly(:)
    integer(int_kind), allocatable :: zoo_loss_lipid(:)
    integer(int_kind), allocatable :: zoo_loss_amino_poly(:)
    integer(int_kind), allocatable :: zoo_loss_protein(:)
    ...
    integer(int_kind), allocatable :: zoo_graze_poly(:)
    integer(int_kind), allocatable :: zoo_graze_lipid(:)
    integer(int_kind), allocatable :: zoo_graze_amino_poly(:)
    integer(int_kind), allocatable :: zoo_graze_protein(:)
...
contains
  ...
  subroutine marbl_particulate_share_destructor(this)
   ...
   !***********************************************************************
    ...
    subroutine dissolved_organic_matter_constructor(this, num_levels)
      ...
      allocate(this%poly_prod(num_levels))
      allocate(this%lipid_prod(num_levels))
      allocate(this%poly_remin(num_levels))
      allocate(this%lipid_remin(num_levels))
      allocate(this%DOCr_remin(num_levels))
      allocate(this%amino_poly_prod(num_levels))
      allocate(this%protein_prod(num_levels))
      allocate(this%amino_poly_remin(num_levels))
      allocate(this%protein_remin(num_levels))
    ...
    !***********************************************************************
     ...
     subroutine dissolved_organic_matter_destructor(this)
       ...
       deallocate(this%poly_prod)
       deallocate(this%lipid_prod)
       deallocate(this%poly_remin)
       deallocate(this%lipid_remin)
       deallocate(this%DOCr_remin)
       deallocate(this%amino_poly_prod)
       deallocate(this%protein_prod)
       deallocate(this%amino_poly_remin)
       deallocate(this%protein_remin)
  ...
  subroutine autotroph_derived_terms_constructor(self, autotroph_cnt, km)
    ...
    allocate(self%auto_loss_poly(autotroph_cnt, km))
    allocate(self%auto_loss_lipid(autotroph_cnt, km))
    allocate(self%auto_loss_amino_poly(autotroph_cnt, km))
    allocate(self%auto_loss_protein(autotroph_cnt, km))
    ...
    allocate(self%auto_graze_poly(autotroph_cnt, km))
    allocate(self%auto_graze_lipid(autotroph_cnt, km))
    allocate(self%auto_graze_amino_poly(autotroph_cnt, km))
    allocate(self%auto_graze_protein(autotroph_cnt, km))
  ...
  subroutine autotroph_derived_terms_destructor(self)
    ...
    deallocate(self%auto_loss_poly)
    deallocate(self%auto_loss_lipid)
    deallocate(self%auto_loss_amino_poly)
    deallocate(self%auto_loss_protein)
    ...
    deallocate(self%auto_graze_poly)
    deallocate(self%auto_graze_lipid)
    deallocate(self%auto_graze_amino_poly)
    deallocate(self%auto_graze_protein)
  ...
  subroutine zooplankton_derived_terms_constructor(self, zooplankton_cnt, km)
    ...
    allocate(self%zoo_graze_poly(zooplankton_cnt, km))
    allocate(self%zoo_graze_lipid(zooplankton_cnt, km))
    allocate(self%zoo_graze_amino_poly(zooplankton_cnt, km))
    allocate(self%zoo_graze_protein(zooplankton_cnt, km))
    ...
    allocate(self%zoo_loss_poly(zooplankton_cnt, km))
    allocate(self%zoo_loss_lipid(zooplankton_cnt, km))
    allocate(self%zoo_loss_amino_poly(zooplankton_cnt, km))
    allocate(self%zoo_loss_protein(zooplankton_cnt, km))
  ...
  subroutine zooplankton_derived_terms_destructor(self)
    ...
    deallocate(self%zoo_graze_poly)
    deallocate(self%zoo_graze_lipid)
    deallocate(self%zoo_graze_amino_poly)
    deallocate(self%zoo_graze_protein)
    deallocate(self%zoo_graze_dic)
    deallocate(self%zoo_loss)
    deallocate(self%zoo_loss_poc)
    deallocate(self%zoo_loss_doc)
    deallocate(self%zoo_loss_poly)
    deallocate(self%zoo_loss_lipid)
    deallocate(self%zoo_loss_amino_poly)
    deallocate(self%zoo_loss_protein)
  ...
  subroutine tracer_index_constructor(this, ciso_on, lvariable_PtoC, autotroph_settings, &
    ...
    call this%add_tracer_index('poly', 'ecosys_base', this%poly_ind, marbl_status_log)
    call this%add_tracer_index('lipid', 'ecosys_base', this%lipid_ind, marbl_status_log)
    call this%add_tracer_index('amino_poly', 'ecosys_base', this%amino_poly_ind, marbl_status_log)
    call this%add_tracer_index('protein', 'ecosys_base', this%protein_ind, marbl_status_log)
  ...
  subroutine interior_diag_ind_destructor(this)
    ...
    if (this%lconstructed()) then
      ...
      deallocate(this%auto_graze_poly_zint)
      deallocate(this%auto_graze_poly_zint_100m)
      deallocate(this%auto_graze_lipid_zint)
      deallocate(this%auto_graze_lipid_zint_100m)
      deallocate(this%auto_graze_amino_poly_zint)
      deallocate(this%auto_graze_amino_poly_zint_100m)
      deallocate(this%auto_graze_protein_zint)
      deallocate(this%auto_graze_protein_zint_100m)
      ...
      deallocate(this%auto_loss_poly_zint)
      deallocate(this%auto_loss_poly_zint_100m)
      deallocate(this%auto_loss_lipid_zint)
      deallocate(this%auto_loss_lipid_zint_100m)
      deallocate(this%auto_loss_amino_poly_zint)
      deallocate(this%auto_loss_amino_poly_zint_100m)
      deallocate(this%auto_loss_protein_zint)
      deallocate(this%auto_loss_protein_zint_100m)
      ...
      deallocate(this%zoo_loss_poly_zint)
      deallocate(this%zoo_loss_poly_zint_100m)
      deallocate(this%zoo_loss_lipid_zint)
      deallocate(this%zoo_loss_lipid_zint_100m)
      deallocate(this%zoo_loss_amino_poly_zint)
      deallocate(this%zoo_loss_amino_poly_zint_100m)
      deallocate(this%zoo_loss_protein_zint)
      deallocate(this%zoo_loss_protein_zint_100m)
      ...
      deallocate(this%zoo_graze_poly_zint)
      deallocate(this%zoo_graze_poly_zint_100m)
      deallocate(this%zoo_graze_lipid_zint)
      deallocate(this%zoo_graze_lipid_zint_100m)
      deallocate(this%zoo_graze_amino_poly_zint)
      deallocate(this%zoo_graze_amino_poly_zint_100m)
      deallocate(this%zoo_graze_protein_zint)
      deallocate(this%zoo_graze_protein_zint_100m)
      ...
      deallocate(this%auto_graze_poly)
      deallocate(this%auto_graze_lipid)
      deallocate(this%auto_graze_amino_poly)
      deallocate(this%auto_graze_protein)
      deallocate(this%auto_graze_zoo)
      deallocate(this%auto_loss)
      deallocate(this%auto_loss_poc)
      deallocate(this%auto_loss_doc)
      deallocate(this%auto_loss_poly)
      deallocate(this%auto_loss_lipid)
      deallocate(this%auto_loss_amino_poly)
      deallocate(this%auto_loss_protein)
      ...
      deallocate(this%zoo_loss_poly)
      deallocate(this%zoo_loss_lipid)
      deallocate(this%zoo_loss_amino_poly)
      deallocate(this%zoo_loss_protein)
      deallocate(this%zoo_graze)
      deallocate(this%zoo_graze_poc)
      deallocate(this%zoo_graze_doc)
      deallocate(this%zoo_graze_poly)
      deallocate(this%zoo_graze_lipid)
      deallocate(this%zoo_graze_amino_poly)
      deallocate(this%zoo_graze_protein)
