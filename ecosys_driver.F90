...
module ecosys_driver
  ...
  use ecosys_tracers_and_saved_state_mod, only : o2_ind, no3_ind, po4_ind, amino_poly_ind, protein_ind, donr_ind, dop_ind, dopr_ind
...
contains
  ...
  subroutine ecosys_driver_init( &
    ...
    amino_poly_ind = marbl_instances(1)%get_tracer_index('amino_poly')
    protein_ind  = marbl_instances(1)%get_tracer_index('protein')
    ...
    poly_ind     = marbl_instances(1)%get_tracer_index('poly')
    lipid_ind    = marbl_instances(1)%get_tracer_index('lipid')
