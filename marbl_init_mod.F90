...
100 format(A, ' tracer module contains ', I0, ' tracers; indices are ', I0, ' to ', I0)
  ...
  subroutine marbl_init_non_autotroph_tracers_metadata(marbl_tracer_metadata, &
    ...
    call marbl_init_non_autotroph_tracer_metadata('poly', 'Dissolved Polysaccharides',    &
               marbl_tracer_metadata(marbl_tracer_indices%poly_ind))
    call marbl_init_non_autotroph_tracer_metadata('lipid', 'Dissolved Lipids',    	  &
               marbl_tracer_metadata(marbl_tracer_indices%lipid_ind))
    call marbl_init_non_autotroph_tracer_metadata('amino_poly', 'Dissolved Amino Polysaccharides',    &
               marbl_tracer_metadata(marbl_tracer_indices%amino_poly_ind))
    call marbl_init_non_autotroph_tracer_metadata('protein', 'Dissolved Proteins',    	  &
               marbl_tracer_metadata(marbl_tracer_indices%protein_ind))
